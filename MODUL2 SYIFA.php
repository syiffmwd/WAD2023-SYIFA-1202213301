            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary mb-3 mt-3 w-100" name="Kalkulator_BMI">Hitung BMI</button>
                    </form>
                    ...
                    <?php
                    if (isset($_POST['Kalkulator_BMI'])) {
                        $tinggi_badan = $_POST['tinggi_badan'];
                        $berat_badan = $_POST['berat_badan'];

                        $tinggi_badan_meter = $tinggi_badan / 100;         //ubah cm ke m
                        $BMI = $berat_badan / $tinggi_badan_meter ** 2;    //Hitung BMI
                        
                        echo "Hasil BMI: " . $BMI;                //Status BMI
                        echo '<br>';
                        if ($BMI <= 18.4) {
                            echo "Underweight";
